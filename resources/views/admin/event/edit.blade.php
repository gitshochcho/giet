...
@section('content')
    @php
        ...
        $speakers      = old('speakers', $event->speakers->map(fn($s) => [
            'id'           => $s->id,
            'name'         => $s->name,
            ...
            'image'        => $s->image,
        ])->toArray() ?: [['id' => null, 'name' => '', 'designation' => '', 'session_role' => '', 'speaker_type' => 'External', 'image' => null]]);
        $evtPartners   = old('event_partners', $event->eventPartners->map(fn($p) => [
            'id'    => $p->id,
            'name'  => $p->name,
            'image' => $p->image,
        ])->toArray() ?: [['id' => null, 'name' => '', 'image' => null]]);
    @endphp

    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6"><h3 class="mb-0">Edit Event</h3></div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="event_format" class="form-select @error('event_format') is-invalid @enderror">
                                            @foreach($formatOptions as $f)
                                                <option value="{{ $f }}" @selected(old('event_format', $event->event_format) === $f)>{{ $f }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="event_date" value="{{ old('event_date', $event->event_date->format('Y-m-d')) }}" class="form-control @error('event_date') is-invalid @enderror">
                                        @error('event_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">End Date</label>
                                        <input type="date" name="event_end_date" value="{{ old('event_end_date', $event->event_end_date?->format('Y-m-d')) }}" class="form-control @error('event_end_date') is-invalid @enderror">
                                        @error('event_end_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Event Time</label>
                                        <input type="text" name="event_time" value="{{ old('event_time', $event->event_time) }}" class="form-control @error('event_time') is-invalid @enderror" placeholder="9:00 AM – 4:30 PM BST">
                                        @error('event_time')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Venue</label>
                                        <input type="text" name="venue" value="{{ old('venue', $event->venue) }}" class="form-control @error('venue') is-invalid @enderror">
                                        @error('venue')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Venue Address</label>
                                        <input type="text" name="venue_address" value="{{ old('venue_address', $event->venue_address) }}" class="form-control @error('venue_address') is-invalid @enderror">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="co_host" value="{{ old('co_host', $event->co_host) }}" class="form-control @error('co_host') is-invalid @enderror">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="registration_status" class="form-select @error('registration_status') is-invalid @enderror">
                                            @foreach($statusOptions as $s)
                                                <option value="{{ $s }}" @selected(old('registration_status', $event->registration_status) === $s)>{{ $s }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="registration_deadline" value="{{ old('registration_deadline', $event->registration_deadline?->format('Y-m-d')) }}" class="form-control @error('registration_deadline') is-invalid @enderror">
                                        @error('registration_deadline')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Registration Fee</label>
                                        <input type="text" name="registration_fee" value="{{ old('registration_fee', $event->registration_fee) }}" class="form-control @error('registration_fee') is-invalid @enderror">
                                        @error('registration_fee')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Capacity (seats)</label>
                                        <input type="number" name="registration_capacity" value="{{ old('registration_capacity', $event->registration_capacity) }}" class="form-control @error('registration_capacity') is-invalid @enderror" min="0">
                                        @error('registration_capacity')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Enquiry Email</label>
                                        <input type="email" name="enquiry_email" value="{{ old('enquiry_email', $event->enquiry_email) }}" class="form-control @error('enquiry_email') is-invalid @enderror">
                                        @error('enquiry_email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-3">
                                        <label class="form-label">Sort Order</label>
                                        <input type="number" name="sort_order" value="{{ old('sort_order', $event->sort_order) }}" class="form-control" min="0">
                                    </div>

                                    <div class="col-md-3 d-flex align-items-end">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="is_past" value="1" id="isPast" @checked(old('is_past', $event->is_past))>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="participant_count" value="{{ old('participant_count', $event->participant_count) }}" class="form-control" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- RIGHT: Hero + Content + Speakers + Partners --}}
                        ...
                        <div class="card card-outline card-info mb-4">
                            ...
                            <div class="card-body">
                                @if($event->heroImageUrl())
                                    <div class="mb-2">
                                        <img src="{{ $event->heroImageUrl() }}" style="max-height:120px;max-width:100%;border-radius:6px;border:1px solid #dee2e6;" alt="Current hero">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <textarea name="about" rows="6" class="form-control @error('about') is-invalid @enderror">{{ old('about', $event->about) }}</textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="who_should_attend" rows="5" class="form-control @error('who_should_attend') is-invalid @enderror">{{ old('who_should_attend', $event->who_should_attend) }}</textarea>
                                    ...
                                    <div class="speaker-row border rounded p-3 mb-3 position-relative">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="speakers[{{ $si }}][name]" value="{{ $spk['name'] ?? '' }}" class="form-control form-control-sm">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label small">Designation</label>
                                                <input type="text" name="speakers[{{ $si }}][designation]" value="{{ $spk['designation'] ?? '' }}" class="form-control form-control-sm">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label small">Session Role</label>
                                                <input type="text" name="speakers[{{ $si }}][session_role]" value="{{ $spk['session_role'] ?? '' }}" class="form-control form-control-sm">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                @if(!empty($spk['image']))
                                                    <p class="text-muted small mb-1">Current: <img src="{{ asset('storage/' . $spk['image']) }}" style="height:30px;border-radius:50%;"></p>
                                                @endif
                                    ...
                                    <div class="partner-row border rounded p-3 mb-3 position-relative">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" name="event_partners[{{ $pi }}][name]" value="{{ $prt['name'] ?? '' }}" class="form-control form-control-sm">
                                            </div>
                                            <div class="col-md-7">
                                                <label class="form-label small">Logo Image</label>
                                                @if(!empty($prt['image']))
                                                    <p class="text-muted small mb-1">Current: <img src="{{ asset('storage/' . $prt['image']) }}" style="height:24px;"></p>
                                                @endif
...
document.getElementById('addSpeaker').addEventListener('click', function () {
    ...
    row.innerHTML = `
        ...
        <div class="row g-2">
            <div class="col-md-4"><label class="form-label small">Name</label><input type="text" name="speakers[${si}][name]" class="form-control form-control-sm" placeholder="Dr. Aminur Rahman"></div>
            <div class="col-md-4"><label class="form-label small">Designation</label><input type="text" name="speakers[${si}][designation]" class="form-control form-control-sm" placeholder="Chairman, GIET Foundation"></div>
            <div class="col-md-4"><label class="form-label small">Session Role</label><input type="text" name="speakers[${si}][session_role]" class="form-control form-control-sm" placeholder="Opening Keynote"></div>
            <div class="col-md-4"><label class="form-label small">Type</label><select name="speakers[${si}][speaker_type]" class="form-select form-select-sm"><option value="GIET">GIET</option><option value="External" selected>External</option></select></div>
            <div class="col-md-8"><label class="form-label small">Photo</label><input type="file" name="speakers[${si}][image]" accept="image/*" class="form-control form-control-sm"></div>
        </div>`;
...
document.getElementById('addEvtPartner').addEventListener('click', function () {
    ...
    row.innerHTML = `
        ...
        <div class="row g-2">
            <div class="col-md-5"><label class="form-label small">Partner Name</label><input type="text" name="event_partners[${pi}][name]" class="form-control form-control-sm" placeholder="Asian Development Bank"></div>
            <div class="col-md-7"><label class="form-label small">Logo Image</label><input type="file" name="event_partners[${pi}][image]" accept="image/*" class="form-control form-control-sm"></div>
        </div>`;
...
function bindRemove(row, cls) {
    row.querySelector('.' + cls).addEventListener('click', () => row.remove());
}
