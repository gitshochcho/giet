...
<section class="ev-hero bg-[#003054] w-full h-auto md:h-[363.3px] relative flex flex-col justify-center items-center text-white overflow-hidden pt-[72px] pb-[72px] px-4 md:px-8 select-none">
  ...
  <div class="w-full max-w-[1204px] mx-auto h-auto flex flex-col items-start text-left z-10 gap-[13.3px]">
    ...
    <h1 style="font-family:'Merriweather',serif;font-weight:800;font-size:clamp(28px,5vw,52px);line-height:1.1;letter-spacing:-0.5px;"
      ...
      {{ $eventsHero?->heading ?: 'Events & Forums' }}
    </h1>
...
<section class="ev-upcoming w-full bg-white py-[88px] px-4 md:px-8">
  <div class="w-full max-w-[1204px] mx-auto flex flex-col gap-[40px]">
    ...
    <div class="flex flex-col gap-2">
      <h4 class="text-[11px] font-semibold text-[#0E606B] uppercase tracking-[1.5px]">Upcoming Events</h4>
      <h2 class="font-serif text-[28px] md:text-[42px] font-extrabold text-[#0F172A]">Open Events</h2>
    </div>

    <div class="flex flex-col gap-8">
      @forelse($upcomingEvents as $ev)
      <a href="{{ route('eventdetails', $ev->id) }}" class="flex gap-6 items-start group cursor-pointer" style="text-decoration:none;">
        ...
        <div class="flex flex-col gap-1">
          ...
          <div class="mt-1">
            ...
            <h4 class="font-['Newsreader'] font-bold text-[15px] leading-[21.3px] text-[#0F172A] max-w-[411px] group-hover:text-[#18909C] transition-colors duration-150">{{ $ev->title }}</h4>
  ...
  <div class="w-full max-w-[1204px] mx-auto flex flex-col gap-[40px]">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div class="flex flex-col gap-[8px]">
        <span class="text-[11px] font-semibold text-[#0E606B] uppercase tracking-[1.5px]">Archive</span>
        <h2 class="font-serif text-[28px] md:text-[42px] font-extrabold text-[#0F172A]">Past Events</h2>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-[30px]">
      ...
      <div class="w-full bg-white border border-[#E4EAF0] rounded-[14px] p-[20px] flex flex-col md:flex-row gap-[24px]">
        <div class="flex flex-col justify-center gap-2 flex-grow">
          ...
          <a href="{{ route('eventdetails', $pe->id) }}" class="text-[#0E606B] font-semibold text-[14px] mt-1 flex items-center hover:underline" style="text-decoration:none;">View Summary →</a>
        </div>
        @if($pe->heroImageUrl())
...
<section class="ev-cta w-full py-[48px] md:py-[80px] relative flex justify-center items-center overflow-hidden select-none" style="background-color:#F1F5F9;">
  ...
  <div class="w-full max-w-[1204px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[60px] items-center relative z-10 px-4 md:px-0">
    ...
    <div class="w-full max-w-[522px] flex flex-col gap-[14px] px-4">
      <span style="font-family:'Inter',sans-serif;font-weight:700;font-size:11px;" class="text-[#0E606B] uppercase tracking-wider">Partner With Us</span>
      <h2 style="font-family:'Merriweather',serif;font-weight:700;font-size:38px;line-height:46px;" class="text-[#003054] tracking-tight">Interested in Co-hosting an Event?</h2>
      <p class="font-['Newsreader'] text-[#475569]" style="font-size:14px;line-height:23px;">GIET welcomes co-hosting proposals from government agencies, development partners, universities, and civil society organizations. We manage logistics, speakers, and documentation.</p>
    </div>
    ...
    <div style="background-color:#FFFFFF;border:1px solid #E4EAF0;border-radius:20px;" class="p-[36px] flex flex-col justify-between shadow-sm">
      <h3 style="font-family:'Merriweather',serif;font-weight:700;font-size:18px;" class="text-[#003054] tracking-tight">Submit an Event Proposal</h3>
      <form class="flex flex-col gap-[14px] mt-[10px] w-full" action="{{ route('contact') }}" method="GET">
        <input type="text" placeholder="Your name" style="font-family:'Inter',sans-serif;background-color:#F8FAFC;border-color:#E4EAF0;"
        ...
        <input type="email" placeholder="Email address" style="font-family:'Inter',sans-serif;background-color:#F8FAFC;border-color:#E4EAF0;"
               class="w-full h-[46px] rounded-[8px] px-[16px] text-[13px] text-[#0F172A] placeholder-[#94A3B8] focus:outline-none focus:border-[#18909C] transition-all border">
        <input type="text" placeholder="Organisation" style="font-family:'Inter',sans-serif;background-color:#F8FAFC;border-color:#E4EAF0;"
               class="w-full h-[46px] rounded-[8px] px-[16px] text-[13px] text-[#0F172A] placeholder-[#94A3B8] focus:outline-none focus:border-[#18909C] transition-all border">
        <textarea placeholder="Describe your event proposal..." rows="3"
                  style="font-family:'Inter',sans-serif;background-color:#F8FAFC;border-color:#E4EAF0;resize:none;"
                  class="w-full h-[88px] rounded-[8px] p-[16px] text-[13px] text-[#0F172A] placeholder-[#94A3B8] focus:outline-none focus:border-[#18909C] transition-all border"></textarea>
        <a href="{{ route('contact') }}" style="font-family:'Inter',sans-serif;background-color:#003054;text-decoration:none;"
           class="w-full h-[44px] rounded-[8px] mt-[4px] text-white font-semibold text-[13px] flex items-center justify-center gap-[6px] hover:bg-[#002040] transition-colors shadow-sm">
