                            ...
                            <table class="table table-striped align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            @if($partner->imageUrl())
                                                <img src="{{ $partner->imageUrl() }}" alt="{{ $partner->name }}" style="height:40px;max-width:80px;object-fit:contain;" loading="lazy" decoding="async">
                                            @else
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                @if($partner->imageUrl())
                                                                    <div class="mb-2 d-flex align-items-center gap-3">
                                                                        <img src="{{ $partner->imageUrl() }}" alt="{{ $partner->name }}" style="height:50px;max-width:120px;object-fit:contain;" loading="lazy" decoding="async">
                                                                        <div class="form-check">
